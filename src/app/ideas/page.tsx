...
const IdeaItem = ({ idea, onToggleStatus, onDeleteIdea }: { idea: Idea, onToggleStatus: (id: string) => void, onDeleteIdea: (id: string) => void }) => {
  return (
    <Card className="shadow-md hover:shadow-lg transition-shadow duration-200">
      ...
      <CardFooter className="flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          />
          <Label htmlFor={`status-${idea.id}`} className="text-sm font-medium">
    ...
    <div className="space-y-6">
      ...
      {filteredAndSortedIdeas.length > 0 ? (
        ...
        <div className="text-center py-10">
          ...
          <h3 className="mt-2 text-lg font-medium">No ideas yet!</h3>
